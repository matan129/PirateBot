 ...
 * @property {Number} label Can take the values 0 = draw no label on pirates, 1 = draw letters on pirates,
 *           2 = draw the pirate id (occurrence in replay file). Default: 0
