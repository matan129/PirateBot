...
%pyexe% "%~dp0lib\playgame.py" --loadtime 10000 --turntime 100 -e -E -d --debug_in_replay --engine_seed 42 --player_seed 42 --log_dir "%~dp0lib\game_logs" --map_file "%map%" "%bot1%" "%bot2%"
goto:EOF
