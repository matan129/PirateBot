...
namespace Pirates
{
    ...
    {
        public Island(int Id, Location Loc, int Owner, int TeamCapturing, int TurnsBeingCaptured, int CaptureTurns,
            int Value)
        {
            this.Id = Id;
            this.Loc = Loc;
        ...
        {
            return string.Format("<Island ID:{0} OWNER:{1} LOC:({2}, {3})>", (object) Id, (object) Owner,
